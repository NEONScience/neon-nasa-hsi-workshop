...
The how-tos and tutorials in this repository require a [NASA Earthdata account](https://urs.earthdata.nasa.gov/), an installation of [Git](https://git-scm.com/downloads), and a compatible Python Environment. Resources in this repository have been developed using the Openscapes 2i2c JupyterHub cloud workspace.
...
**Still having trouble getting a compatible Python environment set up? Contact [ORNL DAAC User Services](uso@daac.ornl.gov).**  
