...
Hands-on exercises will be executed from a [Jupyter Hub on the Openscapes 2i2c cloud instance](https://workshop.openscapes.2i2c.cloud/). Instructions for setting up the Python environment locally are provided in the [setup instructions](setup_instructions.md).
