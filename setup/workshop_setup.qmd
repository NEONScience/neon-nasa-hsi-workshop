...
If you run into any issues, or are testing changes, you may also wish to run *Restart Kernel and Clear Outputs of All Cells* to start over.
<p align="left">
  <img src="../img/restart_kernel_clear_outputs.png" width=100%/>
</p>
