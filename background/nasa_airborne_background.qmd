...
NASA has operated several airborne remote sensing platforms, including AVIRIS, HyTES (Hyperspectral Thermal Emissions Spectrometer), and MASTER (MODIS/ASTER Airborne Simulator). This workshop focuses on data from the AVIRIS sensors, which are the same family the NEON Imaging Spectrometers (AVIRIS-NG).
