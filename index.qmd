...
Hands-on exercises will be executed from a [Jupyter Hub on the Openscapes 2i2c cloud instance](https://workshop.openscapes.2i2c.cloud/). Instructions for setting up the Python environment locally are provided in the [setup instructions](setup/setup_instructions.md).
...
|8:30 AM|Notebook 1: Download and Explore NEON AOP Hyperspectral Data|Bridget Hass|
|9:00 AM|Notebook 2: Pairing NEON AOP Hyperspectral and Field Data|Bridget Hass|
|9:30 AM|Break||
|9:35 AM|Overview of Recent NASA Airborne Missions (SHIFT, BioSCape, AUVELO)|Michele Thornton|  
|10:00 AM|Notebook 3: Discovery and Analysis of VegPlot and AVIRIS Instrument Data|Michele Thornton| 
